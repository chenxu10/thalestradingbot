...
| 4 | **T4 signals** | The business decision — crossing rule earns its regression guard forever. ✅ **DONE** — `tail_ratio.py:29` `signals`, crossing-below rule (prev ≥ line, cur < line), no signal on the line, on days below, or on re-cross above; suite green. |
